...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private boolean b_wasResetByLimit;
    ...
    public ElevatorSubsystem() {
        ...
        m_elevatorLimitSwitch = new DigitalInput(ElevatorConstants.k_elevatorSwitchID);

        b_wasResetByLimit = false;
    ...
    /** Zero the elevator encoder when the limit switch is pressed. (Might have to invert limit switch)*/
    private void zeroElevatorOnLimitSwitch() {
        if (!b_wasResetByLimit && m_elevatorLimitSwitch.get()) {
            // Zero the encoder only when the limit switch is switches from "unpressed" to "pressed" to
            // prevent constant zeroing while pressed
            resetEncoders();
            b_wasResetByLimit = true;
        } else if (m_elevatorLimitSwitch.get()) {
            b_wasResetByLimit = false;
        }
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Coral/Elevator/Actual Position", m_elevatorRightEncoder.getPosition());
    }
}